...
#  Default: ''
# c.ServerApp.password = 'sha1:52156d796eb2:f8d5bc7f0dd5da5aedcd8d4ca85522c6ab920dfe'
...
#  Default: 8888
# c.ServerApp.port = 3930

## The number of additional ports to try if the specified port is not available.
#  Default: 50
# c.ServerApp.port_retries = 5
...
#  Default: ''
# c.ServerApp.root_dir = '/home/ubuntu/OneDrive/Notebooks'
...
## C/C++/Objective-C Language server (clangd)
# c is a magic, lazy variable
c.LanguageServerManager.language_servers = {
    "clangd": {
        # if installed as a binary
        "argv": [shutil.which("clangd", path="/home/jovyan/clangd-linux-11.0.0/bin/"), "-pretty"],
        "languages": ["c++src", "C++src()", "c++src()", "C++src"],
        "version": 2
    }
}
